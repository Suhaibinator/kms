...
func (s *server) newAPIMux() *http.ServeMux {
	...
	mux.HandleFunc("POST /api/v1/applications/{application}/schema-migration", s.handleApplicationSchemaMigration)
	...
	mux.HandleFunc("GET /api/v1/release-subscribers/history", s.handleReleaseSubscriberHistory)
	...
	mux.HandleFunc("GET /api/v1/releases/schema-versions", s.handleListReleaseSchemaVersions)
