...
type ReleaseStore interface {
	...
	ListConfigurationReleases(ctx context.Context, filter domain.ReleaseFilter, page ListPage) ([]domain.ConfigurationReleaseSummary, string, error)
	...
	CountConfigurationReleases(ctx context.Context, filter domain.ReleaseFilter) (uint64, error)
