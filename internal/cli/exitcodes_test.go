...
func TestInvocationErrorsExitUsage(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{[]string{"release", "show", "prod/app", "rel", "--schema-version", "0"}, "requires ENV/APP NAME VERSION"},
		...
		{[]string{"release", "validate", "prod/app", "rel", "v1", "--schema-version", "0"}, "invalid VERSION"},
		{[]string{"release", "activate", "prod:app", "rel", "1", "--schema-version", "0"}, "invalid namespace"},
		...
		{[]string{"release", "diff", "prod/api", "rel", "--schema-version", "0"}, "requires ENV/APP NAME FROM_VERSION TO_VERSION"},
		{[]string{"release", "diff", "prod/api", "rel", "x", "2", "--schema-version", "0"}, "invalid FROM_VERSION"},
		{[]string{"release", "diff", "prod/api", "rel", "1", "y", "--schema-version", "0"}, "invalid TO_VERSION"},
		{[]string{"release", "rollback", "--schema-version", "0"}, "requires ENV/APP NAME"},
