          ...
          <div className="card">
            ...
            <div className="info-panel">
              ...
              <p>
                ...
                is lost, those versions are permanently unrecoverable. Restore procedures should
                verify that the master key provider is reachable before the service reports ready.
              </p>
            </div>
          </div>
        </>
