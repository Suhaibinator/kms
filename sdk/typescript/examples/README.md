...
The [generated managed-configuration guide](../README.md#generated-managed-configuration)
includes a descriptor, exact `kms-config-gen-ts` invocation, generated `Store`
lifecycle, and CI check command. The repository's generated fixture is also
type-checked and exercised by `configgen-generated.test.ts`.
