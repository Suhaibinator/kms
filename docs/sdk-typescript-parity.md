...
| Next.js/React peer majors | optional adapter peers | Next.js 16 and React 19 compatibility | Exact isolated Next.js 16/React 19 build in `.github/workflows/ci.yml` | complete |
